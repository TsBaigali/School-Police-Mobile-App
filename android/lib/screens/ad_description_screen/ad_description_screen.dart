...
class _AdDescriptionScreenState extends State<AdDescriptionScreen> {
                ...
                Column(
                  children: [
                    Container(
                      ...
                      child: CircleAvatar(
                        radius: 50,
                        backgroundImage: NetworkImage('https://media.gettyimages.com/id/1437816897/photo/business-woman-manager-or-human-resources-portrait-for-career-success-company-we-are-hiring.jpg?s=612x612&w=gi&k=20&c=LsB3LmCoN69U82LEYU78IC2tNwOMjy7LJlmEj30UOSs='), // Placeholder image
                      ),
                    ),
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text('${widget.ad.views}', style: const TextStyle(color: Colors.black54)),
                                ],
                              ),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          Text(
                                            'Огноо: ${_formatDate(widget.ad.date)}',
                                            style: const TextStyle(fontSize: 16, color: Colors.black54),
                                          ),
                                        ],
                                      ),
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      _buildActionButton(
                                        ...
                                        icon: Icons.group,
                                        onPressed: _submitRequest, // Submit the request and send the notification
                                      ),
                                      const SizedBox(height: 10),
                                      _buildActionButton(
                                        context,
  ...
  Widget _buildActionButton(BuildContext context,
      {required String label, required Color color, IconData? icon, required VoidCallback onPressed}) {
